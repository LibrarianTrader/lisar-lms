...
function LandingPage({ onLogin }) {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#F8FAFC",fontFamily:"Inter,system-ui,sans-serif"}}>
      ...
      {/* Hero */}
      <div style={{background:`linear-gradient(rgba(15,23,42,.75),rgba(15,23,42,.75)),url('https://i.imgur.com/xNZ43f6.jpeg') center/cover no-repeat`,color:"#fff",padding:"80px 40px",textAlign:"center"}}>
